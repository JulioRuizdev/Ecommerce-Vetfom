/*
  ...
  - The values [toys,other] on the enum `Section` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "Section_new" AS ENUM ('food', 'toy', 'article', 'medicine');
