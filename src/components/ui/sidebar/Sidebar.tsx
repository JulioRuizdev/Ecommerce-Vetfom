...
export const Sidebar = () => {
  ...
  return (
    <div>
        ...
        <nav className={ 
            clsx(
                "fixed left-0 mr-2 top-0 w-[400px] h-screen bg-white z-20 shadow-2xl transform transition-all duration-300",
                {
            ...
            <IoCloseOutline 
                size={50}
                className="absolute top-2 right-6 cursor-pointer p-3"
                onClick={ () => closeMenu() }
            />
